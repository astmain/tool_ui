    ...
    <div class="max-w-6xl mx-auto px-6 py-12">
      <div class="bg-white rounded-2xl p-8 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl"><div class="text-lg font-bold text-green-600 mb-2">JWT 安全</div><div class="text-gray-600 text-sm">Json Web Token 安全认证，保护用户数据</div></div>
          <div class="p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl"><div class="text-lg font-bold text-purple-600 mb-2">Nuxt 框架</div><div class="text-gray-600 text-sm">现代化全栈框架，高效开发体验</div></div>
        </div>
      </div>
    </div>
  </div>
